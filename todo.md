...
## 🐛 BUG CRÍTICO - Loop Infinito de Refresh

- [x] Investigar causa do refresh automático infinito
- [x] Verificar queries tRPC com dependências instáveis
- [x] Verificar useEffect sem array de dependências
- [x] Verificar navegação/redirecionamento em render
- [x] Corrigido: removido useEffect duplicado em FeedFilters.tsx
